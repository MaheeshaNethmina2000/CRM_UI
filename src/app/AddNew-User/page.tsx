              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between border-b border-slate-100 pb-5">
                ...
                <div className="flex items-center space-x-2">
                  <button
                    ...
                    className="inline-flex items-center justify-center space-x-2 rounded-xl bg-slate-100 border border-slate-300 hover:bg-slate-200 text-slate-700 px-4 py-2.5 text-xs font-bold transition-colors cursor-pointer"
                  >
                ...
                <div className="space-y-4">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 text-slate-700 p-4 shadow-sm text-xs space-y-2 font-medium">
                    ...
                    <div className="grid grid-cols-2 gap-y-1.5 text-[11px] pt-1">
                      ...
                      <p className="text-slate-700 font-semibold">Contact:</p>
                      ...
                      <p className="text-slate-700 italic font-medium break-words whitespace-pre-wrap">
                        {objection || "—"}
                      </p>
                    </div>
                  </div>
